...
const ManageClasses = () => {
      ...
      Swal.fire({
         ...
         if (result.isConfirmed) {
            ...
            if (res.data.modifiedCount > 0) {
               ...
               Swal.fire({
                  title: "Unpublished!",
                  text: "Your course has been unpublished.",
                  icon: "success"
                });
            }
         }
  ...
  return (
    <div className='my-10'>
      <h1 className='font-bold text-4xl text-center text-secondary my-10'>Manage <span className='text-black'>Classes</span></h1>
      <div className=''>
