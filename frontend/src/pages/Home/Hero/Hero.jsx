      ...
      <div className='min-h-screen flex justify-start pl-11 items-center text-white bg-black bg-opacity-60'>
         <div>
            ...
            <div className='md:w-1/2'>
               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum at pariatur dolorum nemo ut dicta 
                  necessitatibus, non, sit sed iste totam libero temporibus assumenda mollitia magni, eum rem similique
                   consequuntur?</p>
            </div>
